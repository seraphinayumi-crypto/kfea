-- ================================================
-- KFEA 프로덕션 DB 완전 설정 스크립트
-- ================================================
-- Cloudflare D1 Console에서 아래 쿼리들을 **하나씩** 실행하세요
-- URL: https://dash.cloudflare.com/27cefc8323900e7506870d222bed0ab8/workers-and-pages/d1
-- Database: kfea-production (ID: 81a7641d-edc4-47a1-bc45-8c39257556ba)
-- ================================================

-- 1. 테이블 존재 여부 확인 (먼저 실행)
SELECT name FROM sqlite_master WHERE type='table';

-- 2-1. admins 테이블이 없으면 생성
...
-- 5. 공지사항 ID 1 삭제 (기존 데이터)
DELETE FROM notices WHERE id = 1;

-- 6-1. 공지사항 1 삽입 (팝업 공지사항)
